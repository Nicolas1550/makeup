...
export const fetchCurrentUser = createAsyncThunk(
  ...
  async () => {
    ...
    const response = await axios.get(
      "https://sofiaportafolioonline.latincloud.app/api/users/current",
      {
        headers: {
...
export const fetchUsers = createAsyncThunk("users/fetchUsers", async () => {
  const response = await axios.get("https://sofiaportafolioonline.latincloud.app/api/users");
  return response.data as User[];
});

export const fetchHelpers = createAsyncThunk("users/fetchHelpers", async () => {
  const response = await axios.get(
    "https://sofiaportafolioonline.latincloud.app/api/users/role/ayudante"
  );
  return response.data as User[];
});
...
export const assignRole = createAsyncThunk(
  ...
  async (userId: string, thunkAPI) => {
    try {
      await axios.put(`https://sofiaportafolioonline.latincloud.app/api/users/assignRole/${userId}`, {
        role: "ayudante",
      });
      return userId;
    } catch (error) {
...
export const revokeRole = createAsyncThunk(
  "users/revokeRole",
  async (userId: string) => {
    await axios.put(`https://sofiaportafolioonline.latincloud.app/api/users/revokeRole/${userId}`, {
      role: "ayudante",
    });
    return userId;
  }
