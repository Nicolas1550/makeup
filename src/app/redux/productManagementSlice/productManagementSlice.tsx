...
export const apiUpdateAllPrices = createAsyncThunk(
  ...
  async (percentage: number, { dispatch }) => {
    const response = await axios.put(
      `https://sofiacomar1.latincloud.app/api/products/update-prices`,
      { percentage }
    );
...
export const apiRevertLastPercentage = createAsyncThunk(
  ...
  async (_, { dispatch }) => {
    const response = await axios.put(
      `https://sofiacomar1.latincloud.app/api/products/revert-last-percentage`
    );
...
export const apiAdjustPricesToPreviousPercentage = createAsyncThunk(
  ...
  async (previousPercentage: number, { dispatch }) => {
    const response = await axios.put(
      `https://sofiacomar1.latincloud.app/api/products/adjust-prices`,
      { previousPercentage }
    );
...
export const apiRevertAndApplyNewPercentage = createAsyncThunk(
  ...
  async (newPercentage: number, { dispatch }) => {
    const response = await axios.put(
      `https://sofiacomar1.latincloud.app/api/products/revert-and-apply-percentage`,
      { newPercentage }
    );
    dispatch(
      setMessage(
  ...
  async (newProduct: Omit<Product, "id">, { dispatch }) => {
    ...
    try {
      const response = await axios.post(
        `https://sofiacomar1.latincloud.app/api/products`,
        formData,
        {
          headers: {
...
export const apiDeleteProduct = createAsyncThunk(
  ...
  async (id: number) => {
    await axios.delete(`https://sofiacomar1.latincloud.app/api/products/${id}`);
    return id;
  }
);
