  ...
  async (args: FetchReservationsSummaryArgs, { rejectWithValue }) => {
    ...
    try {
      const response = await axios.get(
        `https://sofiacomar1.latincloud.app/api/servicios/reservas/cierreCaja`,
        {
...
>("services/markReservationAsPending", async (reservationId, thunkAPI) => {
  try {
    const response = await axios.put(
      `https://sofiacomar1.latincloud.app/api/servicios/reservas/${reservationId}/pendiente`
    );
  ...
  async (reservationId: number, thunkAPI) => {
    try {
      const response = await axios.delete(
        `https://sofiacomar1.latincloud.app/api/servicios/reservas/${reservationId}`
      );
      return response.data;
    } catch (error) {
...
>("services/markReservationAsCompleted", async (reservationId, thunkAPI) => {
  try {
    const response = await axios.put(
      `https://sofiacomar1.latincloud.app/api/servicios/reservas/${reservationId}/completar`
    );
    return response.data.message;
  } catch (error) {
    return thunkAPI.rejectWithValue({ errorMessage: (error as Error).message });
...
>("services/fetchReservationsForUser", async (userId) => {
  ...
  const response = await axios.get(
    `https://sofiacomar1.latincloud.app/api/servicios/reservasPorUsuario/${userId}`
  );
...
>("services/fetchReservationsForAssistant", async (params, thunkAPI) => {
  ...
  for (const service of services) {
    ...
    const response = await axios.get(
      `https://sofiacomar1.latincloud.app/api/servicios/${serviceId}/reservasPorAyudante/${params.ayudanteId}`
    );
...
export const deleteServiceOption = createAsyncThunk(
  ...
  async (optionId: number) => {
    ...
    await axios.delete(
      `https://sofiacomar1.latincloud.app/api/servicios/options/${optionId}`,
      {
        headers: {
          "x-auth-token": userToken,
        },
...
export const editServiceOption = createAsyncThunk(
  ...
  async (data: { optionId: number; name: string; price: number }) => {
    ...
    const response = await axios.put(
      `https://sofiacomar1.latincloud.app/api/servicios/options/${data.optionId}`,
      {
        nombre: data.name,
        precio: data.price,
      },
...
export const fetchServiceOptions = createAsyncThunk(
  ...
  async (serviceId: number, thunkAPI) => {
    try {
      const response = await axios.get(
        `https://sofiacomar1.latincloud.app/api/servicios/${serviceId}/options`
      );
...
export const addServiceOption = createAsyncThunk(
  ...
  async (data: { serviceId: number; name: string; price: number }) => {
    ...
    const response = await axios.post(
      `https://sofiacomar1.latincloud.app/api/servicios/${data.serviceId}/options`,
      {
        nombre: data.name,
        precio: data.price,
      },
...
export const uploadServiceImages = createAsyncThunk(
  ...
  async (data: { serviceId: number; images: FormData }) => {
    ...
    try {
      const response = await axios.post(
        `https://sofiacomar1.latincloud.app/api/servicios/${data.serviceId}/uploadImages`,
        formData,
        {
          headers: {
            "x-auth-token": userToken,
...
export const deleteServiceImage = createAsyncThunk(
  ...
  async (data: { serviceId: number; imagePath: string }) => {
    ...
    try {
      const response = await axios.delete(
        `https://sofiacomar1.latincloud.app/api/servicios/${data.serviceId}/deleteImage`,
        {
          headers: {
            "x-auth-token": userToken,
...
export const fetchServiceImages = createAsyncThunk(
  ...
  async (serviceId: number) => {
    ...
    try {
      const response = await axios.get(
        `https://sofiacomar1.latincloud.app/api/servicios/${serviceId}/images`,
        {
          headers: {
            "x-auth-token": userToken,
          },
...
export const updateSocialLinks = createAsyncThunk(
  ...
  async (data: {
    ...
    await axios.put(
      `https://sofiacomar1.latincloud.app/api/servicios/${data.serviceId}/socialLinks`,
      {
...
export const updateServiceDescription = createAsyncThunk(
  ...
  async (data: { serviceId: number; newDescription: string }) => {
    ...
    await axios.put(
      `https://sofiacomar1.latincloud.app/api/servicios/${data.serviceId}`,
...
export const uploadProofOfPayment = createAsyncThunk(
  ...
  async (data: {
    ...
    const response = await axios.post(
      `https://sofiacomar1.latincloud.app/api/servicios/${data.serviceId}/availabilities/${data.disponibilidadId}/uploadProof`,
      formData,
      {
        headers: {
          "x-auth-token": userToken,
...
export const checkIfUserIsAssigned = createAsyncThunk(
  ...
  async (serviceId: number, {}) => {
    ...
    const response = await axios.get(
      `https://sofiacomar1.latincloud.app/api/servicios/${serviceId}/isUserAssigned`,
      {
        headers: {
          "x-auth-token": userToken,
        },
...
export const deleteAvailability = createAsyncThunk(
  ...
  async (availabilityId: number) => {
    ...
    await axios.delete(
      `https://sofiacomar1.latincloud.app/api/servicios/availability/${availabilityId}`,
      {
        headers: {
          "x-auth-token": userToken,
        },
...
export const fetchAvailabilities = createAsyncThunk(
  ...
  async (serviceId: number) => {
    ...
    const response = await axios.get(
      `https://sofiacomar1.latincloud.app/api/servicios/${serviceId}/availabilities`,
      {
        headers: {
          "x-auth-token": userToken,
        },
...
export const addAvailability = createAsyncThunk(
  ...
  async (data: {
    ...
    await axios.post(
      `https://sofiacomar1.latincloud.app/api/servicios/${data.serviceId}/addAvailability`,
      {
...
export const fetchServices = createAsyncThunk(
  ...
  async () => {
    const response = await axios.get("https://sofiacomar1.latincloud.app/api/servicios");
...
export const reserveAvailability = createAsyncThunk(
  ...
  async (data: { serviceId: number; availabilityId: number }) => {
    ...
    const response = await axios.post(
      `https://sofiacomar1.latincloud.app/api/servicios/${data.serviceId}/reserve/${data.availabilityId}`,
      {},
      {
        headers: {
          "x-auth-token": userToken,
...
export const completeReservation = createAsyncThunk(
  ...
  async (reservaId: number) => {
    ...
    await axios.post(
      `https://sofiacomar1.latincloud.app/api/servicios/reservations/${reservaId}/complete`,
      {},
      {
        headers: {
          "x-auth-token": userToken,
...
export const toggleServiceColor = createAsyncThunk(
  ...
  async (serviceId: number) => {
    ...
    const response = await axios.put(
      `https://sofiacomar1.latincloud.app/api/servicios/${serviceId}/toggleColor`,
      {},
      {
        headers: {
          "x-auth-token": userToken,
