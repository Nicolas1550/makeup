...
export const fetchAssistants = createAsyncThunk(
  ...
  async () => {
    const response = await axios.get(
      "https://sofiacomar1.latincloud.app/api/users/role/ayudante"
    );
...
export const fetchAssignedHelpers = createAsyncThunk(
  ...
  async (serviceId: string) => {
    ...
    const response = await axios.get(
      `https://sofiacomar1.latincloud.app/api/servicios/${serviceId}/assignedHelpers`,
      {
        headers: {
...
export const assignAssistant = createAsyncThunk(
  ...
  async ({
    ...
    const userToken = localStorage.getItem("jwt");
    await axios.put(
      `https://sofiacomar1.latincloud.app/api/servicios/${serviceId}/assign`,
      { assistantId },
      {
        headers: {
          "x-auth-token": userToken,
...
export const removeAssistant = createAsyncThunk(
  ...
  async ({
    ...
    const userToken = localStorage.getItem("jwt");
    await axios.put(
      `https://sofiacomar1.latincloud.app/api/servicios/${serviceId}/removeAssistant`,
      { assistantId },
      {
        headers: {
          "x-auth-token": userToken,
