...
export const fetchAssignedHelpers = createAsyncThunk(
  ...
  async (serviceId: string) => {
    ...
    const response = await axios.get(
      `https://sofiaportafolioonline.latincloud.app/api/servicios/${serviceId}/assignedHelpers`,
      {
        headers: {
...
export const assignAssistant = createAsyncThunk(
  ...
  async ({
    ...
    const userToken = localStorage.getItem("jwt");
    await axios.put(
      `https://sofiaportafolioonline.latincloud.app/api/servicios/${serviceId}/assign`,
      { assistantId },
      {
        headers: {
          "x-auth-token": userToken,
...
export const removeAssistant = createAsyncThunk(
  ...
  async ({
    ...
    const userToken = localStorage.getItem("jwt");
    await axios.put(
      `https://sofiaportafolioonline.latincloud.app/api/servicios/${serviceId}/removeAssistant`,
      { assistantId },
      {
        headers: {
          "x-auth-token": userToken,
